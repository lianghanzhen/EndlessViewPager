...
public class ListSamples extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String path = intent.getStringExtra("com.lianghanzhen.endless.viewpager.sample.Path");
    ...
    protected List<Map<String, Object>> getData(String prefix) {
        ...
        mainIntent.addCategory("com.lianghanzhen.endless.viewpager.sample.SAMPLE");
    ...
    protected Intent browseIntent(String path) {
        ...
        result.putExtra("com.lianghanzhen.endless.viewpager.sample.Path", path);
        return result;
    }
